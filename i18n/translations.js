...
export const translations = {
  "fr": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Affiche l'icône StreamPulse à côté de votre pseudo et de ceux des autres utilisateurs dans le tchat Twitch.",
  ...
  "en": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Displays the StreamPulse icon next to your username and those of other users in Twitch chat.",
  ...
  "es": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Muestra el icono de StreamPulse junto a tu nombre y el de otros usuarios en el chat de Twitch.",
  ...
  "pt-BR": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Exibe o ícone do StreamPulse ao lado do seu nome e dos demais usuários no chat da Twitch.",
  ...
  "de": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Zeigt das StreamPulse-Symbol neben deinem Namen und denen anderer Nutzer im Twitch-Chat an.",
  ...
  "it": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Mostra l'icona di StreamPulse accanto al tuo nome e a quello degli altri utenti nella chat di Twitch.",
  ...
  "pl": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Wyświetla ikonę StreamPulse obok Twojego pseudonimu i pseudonimów innych użytkowników na czacie Twitcha.",
  ...
  "tr": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Twitch sohbetinde kullanıcı adınızın ve diğer kullanıcıların yanında StreamPulse simgesini gösterir.",
  ...
  "ru": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Показывает значок StreamPulse рядом с вашим ником и никами других пользователей в чате Twitch.",
  ...
  "ja": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Twitchチャットであなたや他のユーザーの名前の横にStreamPulseアイコンを表示します。",
  ...
  "ko": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "트위치 채팅에서 내 이름과 다른 사용자 이름 옆에 StreamPulse 아이콘을 표시합니다.",
  ...
  "id": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Menampilkan ikon StreamPulse di samping nama Anda dan pengguna lain di obrolan Twitch.",
  ...
  "nl": {
    ...
    "onboarding": {
      ...
      "communityBadgeTitle": "Community-badge",
      "communityBadgeDescription": "Toont het StreamPulse-pictogram naast je naam en die van andere gebruikers in de Twitch-chat.",
  ...
  "sv": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Visar StreamPulse-ikonen bredvid ditt namn och andra användares namn i Twitch-chatten.",
  ...
  "cs": {
    ...
    "onboarding": {
      ...
      "communityBadgeDescription": "Zobrazuje ikonu StreamPulse vedle vašeho jména a jmen ostatních uživatelů v chatu Twitche.",
