  ...
  "fr": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "catalogNote": "Twitch ne date pas ses badges. « Disponibles » regroupe ceux apparus depuis moins de 30 jours et ceux dont le jeu a une campagne en cours : c'est une estimation.",
  ...
  "en": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "catalogNote": "Twitch doesn't date its badges. “Available” groups those that appeared less than 30 days ago and those whose game has a running campaign: it's an estimate.",
  ...
  "es": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "catalogNote": "Twitch no fecha sus insignias. «Disponibles» agrupa las aparecidas hace menos de 30 días y las de juegos con una campaña en curso: es una estimación.",
  ...
  "pt-BR": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "catalogNote": "A Twitch não data seus emblemas. «Disponíveis» reúne os surgidos há menos de 30 dias e os de jogos com campanha em andamento: é uma estimativa.",
  ...
  "de": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "catalogNote": "Twitch datiert seine Abzeichen nicht. „Verfügbar“ zeigt die in den letzten 30 Tagen erschienenen und die, deren Spiel eine laufende Kampagne hat: eine Schätzung.",
        "badgeFilterFree": "Gratis",
  ...
  "it": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "catalogNote": "Twitch non data i suoi badge. «Disponibili» raccoglie quelli comparsi da meno di 30 giorni e quelli il cui gioco ha una campagna in corso: è una stima.",
        "badgeFilterFree": "Gratis",
  ...
  "pl": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "catalogNote": "Twitch nie podaje dat odznak. „Dostępne” to te, które pojawiły się w ciągu 30 dni, i te, których gra ma trwającą kampanię: to szacunek.",
  ...
  "tr": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "catalogNote": "Twitch rozetlerine tarih vermez. «Alınabilir», son 30 günde çıkanları ve oyununun devam eden bir kampanyası olanları gösterir: bu bir tahmindir.",
  ...
  "ru": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "catalogNote": "Twitch не указывает даты значков. «Доступные» — появившиеся за последние 30 дней и те, у чьей игры идёт кампания: это оценка.",
  ...
  "ja": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "badgeAvailable": "入手可能",
        "allBadges": "すべてのバッジ",
        "catalogNote": "Twitch はバッジに日付を付けません。「入手可能」は 30 日以内に登場したものと、ゲームのキャンペーンが開催中のものをまとめた推定です。",
        "badgeFilterFree": "無料",
        "badgeFilterPaid": "有料",
  ...
  "ko": {
    ...
    "popup": {
      ...
      "drops": {
        ...
        "allBadges": "모든 배지",
        "catalogNote": "Twitch는 배지에 날짜를 표시하지 않습니다. '획득 가능'은 30일 이내에 나온 배지와 게임 캠페인이 진행 중인 배지를 모은 추정치입니다.",
        "badgeFilterFree": "무료",
        "badgeFilterPaid": "유료",
