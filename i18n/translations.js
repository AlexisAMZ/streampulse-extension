  ...
  "fr": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}} arrive avec {{viewers}} spectateurs. Rejoins le stream pour les points du raid !",
  ...
  "en": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}} is arriving with {{viewers}} viewers. Join the stream for the raid points!",
  ...
  "es": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}} llega con {{viewers}} espectadores. ¡Únete al directo para conseguir los puntos de la redada!",
  ...
  "pt-BR": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}} está chegando com {{viewers}} espectadores. Entre na live para ganhar os pontos da raid!",
  ...
  "de": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}} kommt mit {{viewers}} Zuschauern. Komm für die Raid-Punkte in den Stream!",
  ...
  "it": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}} arriva con {{viewers}} spettatori. Entra nello stream per i punti del raid!",
  ...
  "pl": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}} nadchodzi z {{viewers}} widzów. Wejdź na stream, aby zdobyć punkty za raid!",
  ...
  "tr": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}}, {{viewers}} izleyiciyle geliyor. Raid puanları için yayına katıl!",
  ...
  "ru": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}} прибывает с {{viewers}} зрителями. Зайди на стрим, чтобы получить очки рейда!",
  ...
  "ja": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}} が {{viewers}} 人の視聴者と到着中。レイドポイントのために配信に参加しよう！",
  ...
  "ko": {
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingMessage": "{{raider}}가 시청자 {{viewers}}명과 함께 도착합니다. 레이드 포인트를 받으려면 스트림에 접속하세요!",
  ...
  "id": {
    ...
    "popup": {
      "history": {
        ...
        "watchVod": "Watch {{name}}'s replay",
        "openChannel": "Open {{name}}'s videos",
        "dismiss": "Hapus {{name}} dari daftar",
        "agoMinutes": "{{count}} min ago",
        "agoHours": "{{count}} h ago",
        "agoDays": "{{count}} d ago"
      },
      ...
      "settings": {
        ...
        "backgroundRaidAlertsTitle": "Peringatan raid masuk (beta)",
        "backgroundRaidAlertsDescription": "Pantau semua kanal Twitch yang kamu ikuti dan beri tahu begitu raid tiba, bahkan saat tidak di halaman.",
        "autoClaimTitle": "Klaim poin saluran secara otomatis",
        "autoClaimDescription": "Secara otomatis mengklaim bonus poin saluran Twitch untuk Anda.",
        ...
        "keepQualityDescription": "Mencegah Twitch menurunkan kualitas atau menjeda saat tab tidak terlihat. Memakai lebih banyak sumber daya. Berlaku saat tab dimuat berikutnya.",
        "autoRefreshTitle": "Pulihkan pemutar saat error",
        "autoRefreshDescription": "Menekan \"Coba lagi\" untukmu pada error #1000 sampai #5000, dan memuat ulang tab bila itu belum cukup.",
        "pipButtonTitle": "Tombol Picture-in-Picture",
        "pipButtonDescription": "Menambahkan tombol di pemutar untuk menonton siaran di jendela mini.",
        "playerQualityTitle": "Kualitas pemutar",
        "playerQualityDescription": "Membuka setiap siaran pada kualitas ini. Auto membiarkan Twitch yang memilih.",
        "playerQualityAuto": "Auto",
        "playerQualitySource": "Sumber",
        "clipDownloadTitle": "Unduh klip",
        "clipDownloadDescription": "Menambahkan tombol di halaman klip untuk menyimpannya sebagai MP4. StreamPulse+.",
      ...
      "notifBlockedBody": "Chrome memblokir notifikasi StreamPulse: kamu tidak akan diberi tahu saat ada siaran langsung.",
      ...
      "preferences": {
        ...
        "keepQualityEnabled": "Kualitas di latar belakang dipertahankan. Muat ulang tab Twitch untuk menerapkan.",
        "keepQualityDisabled": "Kualitas di latar belakang diatur oleh Twitch.",
        "autoRefreshEnabled": "Pemulihan otomatis pemutar diaktifkan.",
        "autoRefreshDisabled": "Pemulihan otomatis pemutar dinonaktifkan.",
        "pipButtonEnabled": "Tombol Picture-in-Picture diaktifkan.",
        "pipButtonDisabled": "Tombol Picture-in-Picture dinonaktifkan.",
        "clipDownloadEnabled": "Unduh klip diaktifkan.",
        "clipDownloadDisabled": "Unduh klip dinonaktifkan.",
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingTitle": "Raid masuk di {{name}}",
        "raidIncomingMessage": "{{raider}} datang dengan {{viewers}} penonton. Bergabung ke stream untuk poin raid!",
    ...
    "changelog": {
      ...
      "supportUrl": "https://streampulse.fr/id/support",
  ...
  "nl": {
    ...
    "popup": {
      "history": {
        ...
        "watchVod": "Watch {{name}}'s replay",
        "openChannel": "Open {{name}}'s videos",
        "dismiss": "{{name}} uit de lijst verwijderen",
        "agoMinutes": "{{count}} min ago",
        "agoHours": "{{count}} h ago",
        "agoDays": "{{count}} d ago"
      },
      ...
      "settings": {
        ...
        "backgroundRaidAlertsTitle": "Meldingen voor binnenkomende raids (bèta)",
        "backgroundRaidAlertsDescription": "Alle gevolgde Twitch-kanalen in de gaten houden en melden zodra een raid binnenkomt, ook buiten de pagina.",
        "autoClaimTitle": "Punten automatisch via het claimkanaal verzamelen",
        "autoClaimDescription": "Klik automatisch op de puntbonussen van Twitch-kanalen voor je.",
        ...
        "keepQualityDescription": "Voorkomt dat Twitch de kwaliteit verlaagt of pauzeert als het tabblad niet zichtbaar is. Gebruikt meer middelen. Geldt vanaf de volgende keer dat het tabblad laadt.",
        "autoRefreshTitle": "Speler herstellen bij fouten",
        "autoRefreshDescription": "Klikt bij fouten #1000 tot #5000 voor je op ‘Opnieuw proberen’ en herlaadt het tabblad als dat niet genoeg is.",
        "pipButtonTitle": "Beeld-in-beeldknop",
        "pipButtonDescription": "Voegt een knop aan de speler toe om de stream in een minivenster te kijken.",
        "playerQualityTitle": "Kwaliteit van de speler",
        "playerQualityDescription": "Opent elke stream in deze kwaliteit. Auto laat Twitch kiezen.",
        "playerQualityAuto": "Auto",
        "playerQualitySource": "Bron",
        "clipDownloadTitle": "Clips downloaden",
        "clipDownloadDescription": "Voegt een knop toe op clippagina's om clips als MP4 op te slaan. StreamPulse+.",
      ...
      "notifBlockedBody": "Chrome blokkeert de meldingen van StreamPulse: je krijgt geen melding van livestreams.",
      ...
      "preferences": {
        ...
        "keepQualityEnabled": "Kwaliteit op de achtergrond blijft behouden. Herlaad het Twitch-tabblad om het toe te passen.",
        "keepQualityDisabled": "Kwaliteit op de achtergrond wordt door Twitch beheerd.",
        "autoRefreshEnabled": "Automatisch herstel van de speler ingeschakeld.",
        "autoRefreshDisabled": "Automatisch herstel van de speler uitgeschakeld.",
        "pipButtonEnabled": "Beeld-in-beeldknop ingeschakeld.",
        "pipButtonDisabled": "Beeld-in-beeldknop uitgeschakeld.",
        "clipDownloadEnabled": "Clips downloaden ingeschakeld.",
        "clipDownloadDisabled": "Clips downloaden uitgeschakeld.",
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingTitle": "Binnenkomende raid op {{name}}",
        "raidIncomingMessage": "{{raider}} komt met {{viewers}} kijkers. Join de stream voor de raidpunten!",
    ...
    "changelog": {
      ...
      "supportUrl": "https://streampulse.fr/nl/support",
  ...
  "hi": {
    ...
    "popup": {
      ...
      "settings": {
        ...
        "backgroundRaidAlertsDescription": "StreamPulse में जोड़े गए सभी Twitch चैनलों पर नज़र रखें और पेज बंद होने पर भी रेड आते ही सूचित करें।",
        "autoClaimTitle": "स्वत: दावा चैनल अंक",
        "autoClaimDescription": "आपके लिए स्वचालित रूप से Twitch चैनल पॉइंट बोनस पर क्लिक करें।",
      ...
      "notifBlockedBody": "Chrome StreamPulse की सूचनाएँ ब्लॉक कर रहा है: आपको लाइव स्ट्रीम की सूचना नहीं मिलेगी।",
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingTitle": "{{name}} पर रेड आ रहा है",
        "raidIncomingMessage": "{{raider}} {{viewers}} दर्शकों के साथ आ रहा है। रेड पॉइंट्स के लिए स्ट्रीम से जुड़ें!",
    ...
    "changelog": {
      ...
      "supportUrl": "https://streampulse.fr/hi/support",
      "pageTitle": "चेंजलॉग",
      "build": "निर्माण",
  ...
  "sv": {
    ...
    "popup": {
      "history": {
        ...
        "watchVod": "Watch {{name}}'s replay",
        "openChannel": "Open {{name}}'s videos",
        "dismiss": "Ta bort {{name}} från listan",
        "agoMinutes": "{{count}} min ago",
        "agoHours": "{{count}} h ago",
        "agoDays": "{{count}} d ago"
      },
      ...
      "settings": {
        ...
        "backgroundRaidAlertsTitle": "Varningar för inkommande raider (beta)",
        "backgroundRaidAlertsDescription": "Bevaka alla Twitch-kanaler du följer och meddela så snart en raid landar, även utanför sidan.",
        "autoClaimTitle": "Automatisk inlösen av kanalpoäng",
        "autoClaimDescription": "Klicka automatiskt på bonuspoäng för Twitch-kanaler åt dig.",
        ...
        "keepQualityDescription": "Hindrar Twitch från att sänka kvaliteten eller pausa när fliken inte visas. Använder mer resurser. Gäller nästa gång fliken laddas.",
        "autoRefreshTitle": "Återställ spelaren vid fel",
        "autoRefreshDescription": "Trycker på ”Försök igen” åt dig vid fel #1000 till #5000 och laddar om fliken om det inte räcker.",
        "pipButtonTitle": "Bild-i-bild-knapp",
        "pipButtonDescription": "Lägger till en knapp i spelaren för att titta på sändningen i ett minifönster.",
        "playerQualityTitle": "Spelarens kvalitet",
        "playerQualityDescription": "Öppnar varje sändning i den här kvaliteten. Auto låter Twitch bestämma.",
        "playerQualityAuto": "Auto",
        "playerQualitySource": "Källa",
        "clipDownloadTitle": "Nedladdning av klipp",
        "clipDownloadDescription": "Lägger till en knapp på klippsidor för att spara klipp som MP4. StreamPulse+.",
      ...
      "notifBlockedBody": "Chrome blockerar aviseringar från StreamPulse: du får ingen avisering när någon går live.",
      ...
      "preferences": {
        ...
        "keepQualityEnabled": "Kvaliteten behålls i bakgrunden. Ladda om Twitch-fliken för att tillämpa.",
        "keepQualityDisabled": "Kvaliteten i bakgrunden hanteras av Twitch.",
        "autoRefreshEnabled": "Automatisk återställning av spelaren är på.",
        "autoRefreshDisabled": "Automatisk återställning av spelaren är av.",
        "pipButtonEnabled": "Bild-i-bild-knappen är på.",
        "pipButtonDisabled": "Bild-i-bild-knappen är av.",
        "clipDownloadEnabled": "Nedladdning av klipp är på.",
        "clipDownloadDisabled": "Nedladdning av klipp är av.",
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingTitle": "Inkommande raid på {{name}}",
        "raidIncomingMessage": "{{raider}} anländer med {{viewers}} tittare. Gå med i streamen för raidpoängen!",
    ...
    "changelog": {
      ...
      "supportUrl": "https://streampulse.fr/sv/support",
  ...
  "cs": {
    ...
    "popup": {
      "history": {
        ...
        "watchVod": "Watch {{name}}'s replay",
        "openChannel": "Open {{name}}'s videos",
        "dismiss": "Odebrat {{name}} ze seznamu",
        "agoMinutes": "{{count}} min ago",
        "agoHours": "{{count}} h ago",
        "agoDays": "{{count}} d ago"
      },
      ...
      "settings": {
        ...
        "backgroundRaidAlertsTitle": "Upozornění na příchozí raidy (beta)",
        "backgroundRaidAlertsDescription": "Sledovat všechny sledované Twitch kanály a upozornit, jakmile přijde raid, i mimo stránku.",
        "autoClaimTitle": "Automatické získávání bodů v kanálu",
        "autoClaimDescription": "Automaticky za vás získává bonusové body za kanály na Twitchi.",
        ...
        "keepQualityDescription": "Zabrání Twitchi snižovat kvalitu nebo pozastavovat přehrávání, když karta není vidět. Využívá více prostředků. Projeví se při příštím načtení karty.",
        "autoRefreshTitle": "Obnovit přehrávač při chybě",
        "autoRefreshDescription": "Klikne za vás na „Zkusit znovu“ u chyb #1000 až #5000 a znovu načte kartu, pokud to nestačí.",
        "pipButtonTitle": "Tlačítko Obraz v obraze",
        "pipButtonDescription": "Přidá do přehrávače tlačítko pro sledování vysílání v mini okně.",
        "playerQualityTitle": "Kvalita přehrávače",
        "playerQualityDescription": "Otevře každé vysílání v této kvalitě. Auto nechá rozhodnout Twitch.",
        "playerQualityAuto": "Auto",
        "playerQualitySource": "Zdroj",
        "clipDownloadTitle": "Stahování klipů",
        "clipDownloadDescription": "Přidá na stránky klipů tlačítko pro uložení v MP4. StreamPulse+.",
      ...
      "notifBlockedBody": "Chrome blokuje oznámení StreamPulse: nedozvíš se o živých vysíláních.",
      ...
      "preferences": {
        ...
        "keepQualityEnabled": "Kvalita na pozadí zůstane zachována. Pro použití znovu načtěte kartu Twitche.",
        "keepQualityDisabled": "Kvalitu na pozadí řídí Twitch.",
        "autoRefreshEnabled": "Automatické obnovení přehrávače zapnuto.",
        "autoRefreshDisabled": "Automatické obnovení přehrávače vypnuto.",
        "pipButtonEnabled": "Tlačítko Obraz v obraze zapnuto.",
        "pipButtonDisabled": "Tlačítko Obraz v obraze vypnuto.",
        "clipDownloadEnabled": "Stahování klipů zapnuto.",
        "clipDownloadDisabled": "Stahování klipů vypnuto.",
    ...
    "background": {
      ...
      "notifications": {
        ...
        "raidIncomingTitle": "Příchozí raid na {{name}}",
        "raidIncomingMessage": "{{raider}} míří s {{viewers}} diváky. Přijďte na stream pro raidové body!",
    ...
    "changelog": {
      ...
      "supportUrl": "https://streampulse.fr/cs/support",
