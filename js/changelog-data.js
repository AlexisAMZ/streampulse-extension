...
export const RELEASES = [
  {
    ...
    date: "2026-09-28",
    title: {
      fr: "Drops, badges et effets de pseudo",
      en: "Drops, badges and username effects",
      es: "Drops, insignias y efectos de nombre",
      "pt-BR": "Drops, emblemas e efeitos de nome",
      de: "Drops, Abzeichen und Namenseffekte",
      it: "Drops, badge ed effetti per il nome",
      pl: "Dropsy, odznaki i efekty nicku",
      tr: "Drop'lar, rozetler ve kullanıcı adı efektleri",
      ru: "Drops, значки и эффекты ника",
      ja: "ドロップ、バッジ、名前エフェクト",
      ko: "드롭, 배지, 닉네임 효과",
    },
    changes: [
      ...
      },
      {
        type: "new",
        text: {
          fr: "Parrainage StreamPulse+ : partage ton code, ton ami a son premier mois offert et tu gagnes un mois gratuit par ami (formule mensuelle). Puis l'effet de pseudo Ambassadeur, l'effet de badge Halo doré, un appareil de plus et une licence à vie à offrir. Tout est détaillé sur l'écran StreamPulse+.",
          en: "StreamPulse+ referrals: share your code, your friend gets their first month free and you get a free month per friend (monthly plan). Then the Ambassador username effect, the Golden halo badge effect, one more device and a lifetime licence to give away. Everything is laid out on the StreamPulse+ screen.",
          es: "Invitaciones StreamPulse+: comparte tu código, tu amigo tiene su primer mes gratis y tú ganas un mes gratis por amigo (plan mensual). Después, el efecto de nombre Embajador, el efecto de insignia Halo dorado, un dispositivo más y una licencia de por vida para regalar. Todo está detallado en la pantalla StreamPulse+.",
          "pt-BR": "Indicações StreamPulse+: compartilhe seu código, seu amigo ganha o primeiro mês grátis e você ganha um mês grátis por amigo (plano mensal). Depois, o efeito de nome Embaixador, o efeito de emblema Halo dourado, um dispositivo a mais e uma licença vitalícia para presentear. Tudo está detalhado na tela StreamPulse+.",
          de: "StreamPulse+ Empfehlungen: Teile deinen Code, dein Freund bekommt den ersten Monat gratis und du einen Gratismonat pro Freund (Monatsabo). Danach der Namenseffekt Botschafter, der Abzeichen-Effekt Goldener Heiligenschein, ein Gerät mehr und eine Lebenszeit-Lizenz zum Verschenken. Alles steht auf dem StreamPulse+-Bildschirm.",
          it: "Inviti StreamPulse+: condividi il tuo codice, il tuo amico ha il primo mese gratis e tu ottieni un mese gratis per amico (piano mensile). Poi l'effetto nome Ambasciatore, l'effetto badge Alone dorato, un dispositivo in più e una licenza a vita da regalare. Tutto è spiegato nella schermata StreamPulse+.",
          pl: "Polecenia StreamPulse+: udostępnij swój kod, znajomy dostaje pierwszy miesiąc za darmo, a ty darmowy miesiąc za każdego znajomego (plan miesięczny). Potem efekt nicku Ambasador, efekt odznaki Złota aureola, jedno urządzenie więcej i dożywotnia licencja do podarowania. Wszystko jest opisane na ekranie StreamPulse+.",
          tr: "StreamPulse+ davetleri: kodunu paylaş, arkadaşın ilk ayı ücretsiz alsın, sen de her arkadaş için bir ay ücretsiz kazan (aylık plan). Ardından Elçi kullanıcı adı efekti, Altın hale rozet efekti, bir cihaz daha ve hediye edilecek ömür boyu lisans. Hepsi StreamPulse+ ekranında anlatılıyor.",
          ru: "Рефералы StreamPulse+: поделитесь кодом, друг получит первый месяц бесплатно, а вы — бесплатный месяц за каждого друга (месячный план). Затем эффект ника «Посол», эффект значка «Золотой ореол», ещё одно устройство и пожизненная лицензия в подарок. Всё подробно на экране StreamPulse+.",
          ja: "StreamPulse+ の紹介：コードを共有すると友達は最初の1か月が無料、あなたは友達1人につき1か月無料（月額プラン）。さらにアンバサダーの名前エフェクト、金色の光輪バッジエフェクト、デバイス1台追加、プレゼント用の永久ライセンス。詳しくは StreamPulse+ 画面で。",
          ko: "StreamPulse+ 추천: 코드를 공유하면 친구는 첫 달 무료, 나는 친구 한 명당 한 달 무료(월간 플랜). 이어서 앰배서더 닉네임 효과, 황금 후광 배지 효과, 기기 한 대 추가, 선물용 평생 라이선스까지. 자세한 내용은 StreamPulse+ 화면에 있어요.",
        },
      },
      {
        type: "new",
      ...
      },
      {
        type: "new",
        text: {
          fr: "Sur l'accueil, une bande montre le Drop qui avance : récompense, jeu, chaîne, barre de progression et temps restant. Un clic ouvre le panneau Drops.",
          en: "On the home screen, a strip shows the Drop in progress: reward, game, channel, progress bar and time left. One click opens the Drops panel.",
          es: "En la pantalla de inicio, una banda muestra el Drop en curso: recompensa, juego, canal, barra de progreso y tiempo restante. Un clic abre el panel Drops.",
          "pt-BR": "Na tela inicial, uma faixa mostra o Drop em andamento: recompensa, jogo, canal, barra de progresso e tempo restante. Um clique abre o painel Drops.",
          de: "Auf dem Startbildschirm zeigt ein Streifen den laufenden Drop: Belohnung, Spiel, Kanal, Fortschrittsbalken und Restzeit. Ein Klick öffnet das Drops-Panel.",
          it: "Nella schermata iniziale, una fascia mostra il Drop in corso: ricompensa, gioco, canale, barra di avanzamento e tempo rimanente. Un clic apre il pannello Drops.",
          pl: "Na ekranie głównym pasek pokazuje Drop w toku: nagrodę, grę, kanał, pasek postępu i pozostały czas. Kliknięcie otwiera panel Dropsów.",
          tr: "Ana ekranda bir şerit ilerleyen Drop'u gösterir: ödül, oyun, kanal, ilerleme çubuğu ve kalan süre. Tek tıkla Drops paneli açılır.",
          ru: "На главном экране полоса показывает текущий Drop: награду, игру, канал, шкалу прогресса и оставшееся время. Клик открывает панель Drops.",
          ja: "ホーム画面に進行中のドロップを表示する帯を追加：報酬、ゲーム、チャンネル、進捗バー、残り時間。クリックで Drops パネルが開きます。",
          ko: "홈 화면에 진행 중인 드롭을 보여주는 띠가 추가됩니다: 보상, 게임, 채널, 진행 막대, 남은 시간. 클릭하면 Drops 패널이 열립니다.",
        },
      },
      {
        type: "improved",
