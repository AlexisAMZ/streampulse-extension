...
export const RELEASES = [
  {
    ...
    date: "2026-09-28",
    title: {
      fr: "Tes Drops, en un coup d'œil",
      en: "Your Drops, at a glance",
      es: "Tus Drops, de un vistazo",
      "pt-BR": "Seus Drops, num relance",
      de: "Deine Drops auf einen Blick",
      it: "I tuoi Drops, a colpo d'occhio",
      pl: "Twoje Dropsy w jednym miejscu",
      tr: "Drop'ların tek bakışta",
      ru: "Ваши Drops с первого взгляда",
      ja: "ドロップをひと目で",
      ko: "드롭을 한눈에",
    },
    changes: [
