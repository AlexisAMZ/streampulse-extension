...
export const RELEASES = [
  {
    ...
    changes: [
      ...
      },
      {
        ...
        area: "fixes",
        text: {
          fr: "Image du récap : le temps regardé ne déborde plus au-delà de 100 heures, le nom de ta chaîne favorite s'affiche en entier, StreamPulse n'est plus écrit trois fois, et l'image téléchargée est deux fois plus nette.",
          en: "Recap image: watch time no longer overflows past 100 hours, your favorite channel's name is shown in full, StreamPulse is no longer written three times, and the downloaded image is twice as sharp.",
          es: "Imagen del resumen: el tiempo visto ya no se desborda a partir de 100 horas, el nombre de tu canal favorito se ve completo, StreamPulse ya no aparece tres veces y la imagen descargada es el doble de nítida.",
          "pt-BR": "Imagem do resumo: o tempo assistido não transborda mais acima de 100 horas, o nome do seu canal favorito aparece inteiro, StreamPulse não aparece mais três vezes e a imagem baixada é duas vezes mais nítida.",
          de: "Rückblick-Bild: Die Zuschauzeit läuft über 100 Stunden nicht mehr über, der Name deines Lieblingskanals erscheint vollständig, StreamPulse steht nicht mehr dreimal da und das heruntergeladene Bild ist doppelt so scharf.",
          it: "Immagine del riepilogo: il tempo guardato non trabocca più oltre le 100 ore, il nome del tuo canale preferito appare per intero, StreamPulse non è più scritto tre volte e l'immagine scaricata è due volte più nitida.",
          pl: "Obrazek podsumowania: czas oglądania nie wychodzi już poza ramkę powyżej 100 godzin, nazwa ulubionego kanału jest widoczna w całości, StreamPulse nie pojawia się już trzy razy, a pobrany obrazek jest dwa razy ostrzejszy.",
          tr: "Özet görseli: izleme süresi 100 saati aşınca artık taşmıyor, favori kanalının adı tam görünüyor, StreamPulse artık üç kez yazılmıyor ve indirilen görsel iki kat daha net.",
          ru: "Картинка итогов: время просмотра больше не вылезает за край после 100 часов, название любимого канала видно целиком, StreamPulse больше не написан трижды, а скачанная картинка вдвое чётче.",
          ja: "まとめ画像：100時間を超えても視聴時間がはみ出さなくなり、一番見たチャンネル名が全部表示され、StreamPulse が3回書かれなくなり、ダウンロード画像が2倍鮮明になりました。",
          ko: "결산 이미지: 시청 시간이 100시간을 넘어도 더 이상 넘치지 않고, 가장 많이 본 채널 이름이 전부 보이며, StreamPulse가 세 번 쓰이지 않고, 다운로드 이미지가 두 배 선명해졌습니다.",
        },
      },
      {
        type: "fix",
